...
export default class AccountCriticalSuccessFactorMutliPicklist extends LightningElement {
    @track options = [];
  @api prodOptions;
  @track error;
  @track dropdown =
  ...
  connectedCallback() {
    getPickList({objectName: "Account", fieldName: "Critical_Success_Factor_for_Aim__c"})
    .then(data => {                     
      if (data) {
        this.dataList = data;
